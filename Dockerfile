...
# Create mask user
RUN adduser --system --group --disabled-password mask && \
	mkdir -p /wallet /home/mask/.mask && \
	chown -R mask:mask /home/mask/.mask && \
	chown -R mask:mask /wallet

# Contains the blockchain
VOLUME /home/mask/.mask
...
ENTRYPOINT ["maskd", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=48080", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=18081", "--non-interactive", "--confirm-external-bind"]
